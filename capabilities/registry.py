...
CAPS: list[tuple] = [
    ...
    ("preview.document", 2, "core", "platform", [],
     "ch11", "r03-file-explorer",
     "Show what a document is before anyone acts on it, at a chosen size."),
    ("preview.resource", 3, "extended", "wire",
     [("core", "resource_link"), ("apps", "serverResources"),
      ("apps", "resources/read")],
     "ch11", "r03-file-explorer",
     "Preview a resource the server linked rather than embedded."),
...
RECIPES = [
    ...
    ("r03", "File Explorer", "Hierarchical browse and manage.",
     ["input.contextmenu", "input.dragdrop", "input.longpress", "input.selection",
      ...
      "preview.document", "preview.resource"]),
